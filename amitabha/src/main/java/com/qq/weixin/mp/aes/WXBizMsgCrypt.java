...
public class WXBizMsgCrypt {
	...
	public static WXBizMsgCrypt getInstance(String token, String encodingAesKey, String appId) throws Exception {
		if (pc == null || !_token.equals(token) || !_encodingAesKey.equals(encodingAesKey) || !_appId.equals(appId)) {
			_token = token;
